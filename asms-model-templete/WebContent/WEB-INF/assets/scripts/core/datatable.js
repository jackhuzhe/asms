...
var Datatable = function () {
    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {  // language settings
                        ...
                        "sLengthMenu": "<span class='seperator'>\u9875|</span>\u6bcf\u9875 _MENU_ \u6761",
                        "sInfo": "<span class='seperator'>|</span>\u603b\u5171 _TOTAL_ \u6761\u8bb0\u5f55",
                        "sInfoEmpty": "",
                    ...
                    "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                      oSettings.jqXHR = $.ajax( {
                        ...
                        "type": "POST",
                        "url": sSource,
                        "data": JSON.stringify(Custom.convertToJson(aoData)),
            ...
            $('tbody tr', table).live('click' , function(event) {
        		
        		$(table.fnSettings().aoData).each(function() {
        			$(this.nTr).removeClass('success');
        			$(this.nTr).find(':checkbox').attr("checked", false);
        			$(this.nTr).find('.checked').removeClass("checked");
        		});
